...
format: html
categories: [deep-learning, 🟡medium]
...
$\large \frac{d\sigma(x)}{dx}=\sigma(x)(1-\sigma(x))$ reaches its maximum value of 0.25 at $x=0$, and is zero when $\sigma(x)$ saturates at 0 or 1. For more clarity, the following plot shows both the sigmoid function and its derivative.

<div style="text-align: center;">
  <img src="../images/sigmoid_derivative.png" alt="Logo" width="500"/>
</div>
